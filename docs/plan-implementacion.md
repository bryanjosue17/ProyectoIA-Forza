...
| 17 | Módulo Nómina (renombrado + expandido) | ✅ | NominaType enum, Notes field, migración DB, rutas /api/nomina, página Colaborador (`Nomina.jsx`) y RRHH (`Nomina.jsx`) |
...
- ✅ Solucionado el problema de ruteo de Swagger UI (`404 Route Not Found`) abriendo un NodePort directo (30099).
- ✅ Documentación final consolidada, catálogos de prompts creados y propuesta PDF generada.
